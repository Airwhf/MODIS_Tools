...
def main(date_label, input_directory, output_directory):
    ...
    for i in file_list:
        ...
        #  获取要转换的子数据集
        data = datasets.GetSubDatasets()[4][0]
...
if __name__ == "__main__":
    # ********************** scale factor = 1.0 **********************
    input_directory = '/mnt/f/PRD_urbanization/MCD12Q1/2020_LULC_MODIS'
    output_directory = '/mnt/f/PRD_urbanization/MCD12Q1/2020_LULC_MODIS/geo_band_PFT'
